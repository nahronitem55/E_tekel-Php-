            ...
            $zaman=explode(" ",$kullanicicek['kullanici_zaman']);
             ...
             ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kullanici_unvan"  disabled="" value="<?php echo $kullanicicek['kullanici_unvan'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kullanici_resim"   value="<?php echo $kullanicicek['kullanici_resim'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
