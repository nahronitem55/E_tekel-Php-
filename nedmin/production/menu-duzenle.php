          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <input type="" id="first-name" name="kullanici_tc" disabled="" value="<?php echo $_SERVER['HTTP_HOST']."/".$_SERVER['REQUEST_URI']?>/sayfa-<?php  echo seo ($menucek['menu_ad'])?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
