        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-beer"></i> <span>E TEKEL</span></a>
                </div>
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img width="100" src="../../<?php echo $kullanicicek['kullanici_resim'] ?>" alt="..." class="img-circle profile_img">
                     </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="" alt=""><?php echo $kullanicicek['kullanici_adsoyad'] ?>
